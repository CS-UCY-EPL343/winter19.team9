...
class EditAccount extends Component {
    ...
    fillCSV = (name,surname,email,username,password,bdate,age, PT, classes)=> {
        // console.log(name);
        //
        // this.state.csvData =[
                    ...
                    <AnimatedOnScroll animationIn = "slideInDown">
                        ...
                        >
                            ...
                            <div className = "form-group" id = "buttons">
                                ...
                                <label id = "csv">
                                    <CSVLink data={this.fillCSV(this.state.Name,this.state.Surname,this.state.Email,this.state.username,this.state.password,this.state.Bdate,this.state.Age, this.props.dataPT, this.props.classes)}>Download my Data</CSVLink>
                                </label>
                            </div>
                        </form>
                    </AnimatedOnScroll>
