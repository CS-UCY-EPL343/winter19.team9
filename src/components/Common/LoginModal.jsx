...
class LoginModal extends Component {
    render() {
        return (
            ...
            <form id="LoginModal" tabIndex="-1" className="modalBack modal-content animate" action="#" method="post"
                ...
                <div className="search container">
                    <form id="form" className="form-row needs-validation" noValidate>
                        <div className="form-group row-lg-12 row-md-12 row-sm-12" id="addressID">
                            <label htmlFor="username"> <i className="fa fa-user coloring"/> <span
                                className="textFields">Username or email </span>
                                <span
                                    className="red">*</span></label>
                            <input type="text" className="form-control" id="username" pattern="^ *[a-zA-Z0-9]+.*"
                                   placeholder="Enter username or email" required/>

                        </div>
                        <div className="form-group col-lg-12 col-md-12 col-sm-12">
                            <label htmlFor="pword"> <i className="fa fa-lock coloring"/> <span
                                className="textFields">Password </span><span
                                className="red">*</span></label>
                    ...
                    <div className="container">
                        <div className="row d-flex justify-content-between login-help">
                            <span id="signup">Don't have an account? <Link onClick={this.props.toggle} to="/register">Sign Up</Link></span>
