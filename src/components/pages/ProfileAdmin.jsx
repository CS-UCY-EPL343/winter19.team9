...
import {
    ...
    getPersonalTraining, getAllCoaches, getCoachTraining, loggedInVisit, updateProfileVisit, userPic
} from "../../repository";
...
class ProfileAdmin extends Component {
    ...
    handleDayTimeChange = (day, time, flag, Coach_ID) => {
        this.setState({day, time, flag, Coach_ID}, () => {
            // console.log("CoachID and UserID: " + this.state.Coach_ID + " " +this.state.User_ID);
            getCoachTraining(Coach_ID).then(response => {
                this.setState(
                    {trainingScheduleCoach: response}, () => {
                        // console.log("this is the coach id:  " + Coach_ID);
                        // console.log("this the coach's returned schedule: \n" + this.state.trainingScheduleCoach);
                    });
            });
        });
    };
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-8">
                                        <Timetable day={this.state.day} time={this.state.time} flag={this.state.flag}
                                                   ...
                                                   trainingScheduleCoach={this.state.trainingScheduleCoach}/>
                                    </div>
                                    <div className="col-md-4">
